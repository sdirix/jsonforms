/*! jsonforms - v0.0.9 - 2015-12-08 Copyright (c) EclipseSource Muenchen GmbH and others. */ 
'use strict';
// Source: temp/utils.js
/*! jsonforms - v0.0.9 - 2015-12-08 Copyright (c) EclipseSource Muenchen GmbH and others. */ 
// Source: components/utils/dataproviders.js
...
(function (JSONForms) {
    var DefaultDataProvider = (function () {
        ...
        DefaultDataProvider.prototype.getPageSize = function () {
            return this._pageSize;
        };
        DefaultDataProvider.prototype.getPage = function () {
            return this._page;
        };
        ...
        DefaultDataProvider.prototype.filter = function (terms) {
            return undefined;
        };
    ...
    var DefaultInternalDataProvider = (function () {
        ...
        DefaultInternalDataProvider.prototype.getPageSize = function () {
            return this._pageSize;
        };
        DefaultInternalDataProvider.prototype.getPage = function () {
            return this._page;
        };
        ...
        DefaultInternalDataProvider.prototype.fetchPage = function (page) {
            return undefined;
        };
        DefaultInternalDataProvider.prototype.filter = function () {
            return undefined;
        };
        DefaultInternalDataProvider.prototype.setPageSize = function (size) {
        };
...
// Source: components/utils/pathutil.js
///<reference path="../references.ts"/>
var JSONForms;
(function (JSONForms) {
...
// Source: components/utils/ruleservice.js
///<reference path="../references.ts"/>
var JSONForms;
(function (JSONForms) {
...
// Source: components/utils/services.js
///<reference path="../references.ts"/>
var JSONForms;
(function (JSONForms) {
...
// Source: components/pathresolver/jsonforms-pathresolver.js
///<reference path="../references.ts"/>
var JSONForms;
(function (JSONForms) {
...
// Optimized: Yes
// File:      components/pathresolver/pathresolver.js
//====================================================================================================================
...
//--------------------------------------------------------------------------------------------------------------------
// File: components/pathresolver/pathresolver-service.js
//--------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  var ArrayRenderer = (function () {
      ...
      ArrayRenderer.isExternalFilterAvailable = function (dataProvider, options) {
          return dataProvider.filter !== undefined &&
              options.hasOwnProperty('useExternalFiltering');
      };
      ArrayRenderer.isExternalPagingAvailable = function (dataProvider, options) {
      ...
      ArrayRenderer.prototype.defaultGridOptions = function (existingOptions, services, schema) {
          ...
          var externalPaginationEnabled = ArrayRenderer.isExternalPagingAvailable(dataProvider, existingOptions);
          var externalFilteringEnabled = ArrayRenderer.isExternalFilterAvailable(dataProvider, existingOptions);
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  var IntegerRenderer = (function () {
      ...
      IntegerRenderer.prototype.render = function (element, subSchema, schemaPath, services) {
          ...
          control['template'] = "<jsonforms-control><input type=\"number\" step=\"1\" id=\"" + schemaPath + "\" class=\"form-control jsf-control jsf-control-integer\" data-jsonforms-validation data-jsonforms-model/></jsonforms-control>";
          return control;
      };
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  var StringRenderer = (function () {
      ...
      StringRenderer.prototype.render = function (element, subSchema, schemaPath, services) {
          var control = JSONForms.RenderDescriptionFactory.createControlDescription(schemaPath, services, element);
          control['template'] = "<jsonforms-control>\n        <input type=\"text\" id=\"" + schemaPath + "\" class=\"form-control jsf-control jsf-control-string\" data-jsonforms-model data-jsonforms-validation/>\n        </jsonforms-control>";
          return control;
      };
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  var NumberRenderer = (function () {
      ...
      NumberRenderer.prototype.render = function (element, subSchema, schemaPath, services) {
          var control = JSONForms.RenderDescriptionFactory.createControlDescription(schemaPath, services, element);
          control['template'] = "<jsonforms-control>\n        <input type=\"number\" step=\"0.01\" id=\"" + schemaPath + "\" class=\"form-control jsf-control jsf-control-number\" data-jsonforms-validation data-jsonforms-model/>\n        </jsonforms-control>";
          return control;
      };
